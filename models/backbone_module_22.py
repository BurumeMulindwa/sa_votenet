...
class nsigmoid(nn.Module):
    ...
    def forward(self, x):
        ...
        '''
        f = 3.15 * ((100 * torch.log(torch.exp((3 * x) / 100 + 3 / 2000) + 1)) / 3 - (
                    100 * torch.log(torch.exp((3 * x) / 100 - 3 / 2000) + 1)) / 3 - (
                                100 * torch.log(torch.exp((3 * x) / 100 - 3 / 10000) + 1)) / 3 + (
                                100 * torch.log(torch.exp((3 * x) / 100 + 3 / 10000) + 1)) / 3 - (
                                100 * torch.log(torch.exp((3 * x) / 100 - 9 / 10000) + 1)) / 3 + (
                                100 * torch.log(torch.exp((3 * x) / 100 + 9 / 10000) + 1)) / 3 - (
                                100 * torch.log(torch.exp((3 * x) / 100 - 21 / 10000) + 1)) / 3 + (
                                100 * torch.log(torch.exp((3 * x) / 100 + 21 / 10000) + 1)) / 3)
